    ...
    <el-container>
      ...
      <el-container>
        ...
        <el-main>
          ...
          <router-view name="viewAdmin"></router-view>
          <router-view name="viewSystem"></router-view>
          <router-view name="viewPermission"></router-view>
          <router-view name="viewOrder"></router-view>
        </el-main>
      </el-container>
    </el-container>
  </div>
